...
class MinesweeperBoard {
  ...
  public:
    ...
    bool** loopPrevention; //prevents looping
    bool area; //16x16 or 8x8 squares
    ...
    void drawSelection(uint8_t x, uint8_t y, bool flash, Adafruit_SSD1306& display);
    void draw(bool drawMines, Adafruit_SSD1306& display);
